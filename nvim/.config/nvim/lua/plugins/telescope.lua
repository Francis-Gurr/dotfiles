return {
	...
	config = function()
		...
		vim.keymap.set("n", "<leader>sf", builtin.git_files, { desc = "Search git [f]iles" })
		-- vim.keymap.set("n", "<leader>sF", builtin.find_files, { desc = "Search all [F]iles" })
		...
		vim.keymap.set(
			...
			{ desc = "Search by grep with [a]rguments" }
		)
		...
		vim.keymap.set("n", "<leader>sh", builtin.search_history, { desc = "Search [h]istory" })

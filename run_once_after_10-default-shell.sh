...
[ "$login_shell" = "$zsh_path" ] || { chsh -s "$zsh_path"; echo "default-shell: run 'exec zsh' to switch this terminal now; log out and back in for new terminals to pick it up (they inherit \$SHELL from the session)"; }
